...
namespace BMSManagerRebuilt.GUIOperation.PackTopology
{
    ...
    /// </summary>
    public sealed partial class Module3Page : Page
    {
        ...
        {
            MainWindow.Module3Setting = setting;
            logger.LogDebug("Module 3: {module1}", MainWindow.Module3Setting);
        }
        ...
        private void Module3CheckBox_Checked(object sender, RoutedEventArgs e)
        {

        }

        private void Module3CheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
