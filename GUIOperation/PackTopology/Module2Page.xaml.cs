...
namespace BMSManagerRebuilt.GUIOperation.PackTopology
{
    ...
    /// </summary>
    public sealed partial class Module2Page : Page
    {
        ...
        {
            MainWindow.Module2Setting = setting;
            logger.LogDebug("Module 2: {module1}", MainWindow.Module2Setting);
        }
        ...
        private void Module2CheckBox_Checked(object sender, RoutedEventArgs e)
        {

        }

        private void Module2CheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
